...
We are going to develop a training system with augmented reality hardware. Envision a scenario: A trainer is directing the trainees on how to operate a machine that consists of multiple movable components.
