...
However, CMR systems often require very high network bandwidth which is seldom available and suffer from interaction latency~\cite{chen2014}. However some attempts have been made to improve such systems. 
