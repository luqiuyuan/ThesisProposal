...
\include{parts/10-introduction}
\include{parts/20-background}
\include{parts/30-details-about-the-method}
\include{parts/31-evaluation}
\include{parts/40-video-object-segmentation}
\include{parts/50-hybrid-remote-rendering}
\include{parts/60-conclusion}
...
%
%\include{parts/appendix-help} %"Sources of Information and Help"
%\include{parts/appendix-matlab} %"Matlab Code for Making a PDF Plot"
